...
#ifndef GRAPH_PUZZLE_GAME_GUZ_ERHAN_OZU_MAIN_ABSTRACTGRAPH_H
#define GRAPH_PUZZLE_GAME_GUZ_ERHAN_OZU_MAIN_ABSTRACTGRAPH_H
...
#endif //GRAPH_PUZZLE_GAME_GUZ_ERHAN_OZU_MAIN_ABSTRACTGRAPH_H
